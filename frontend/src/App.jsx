...
import ManageLager from './pages/admin/ManageLager.jsx'
import ManageArchive from './pages/admin/ManageArchive.jsx'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin/arkiv" element={<ProtectedRoute><ManageArchive /></ProtectedRoute>} />
